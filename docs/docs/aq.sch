...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Argonaut_Q_Profile
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Questionnaire/f:item/f:options">
      <sch:assert test="f:reference[starts-with(@value, '#')]">SHALL be a reference to a contained valueset. (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
